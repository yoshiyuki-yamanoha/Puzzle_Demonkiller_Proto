...
public class MagicRangeDetector2 : TrunManager
{
    const int stageWidth = 20;
    const int stageHeight = 20;

    [SerializeField,Range(1,8)] private int freeMagicLevel = 1;
    ...
    //現在の位置を取得する用
    [SerializeField] MagicMassSelecter2 s_MagicMassSelecter;
